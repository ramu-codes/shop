  ...
  return (
    <div className="space-y-4 pb-6">
      ...
      <div className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mt-2">
          Payment Log
        </h2>
          ...
          payments.map((payment) => (
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-bold text-textDark leading-tight">
              ...
              <div className="text-right">
                ...
                <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-gray-100 text-gray-600 uppercase tracking-wider">
                  Settled
                </span>
              </div>
            </div>
